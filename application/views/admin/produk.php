        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="white-box">
                            <form class="form-horizontal form-material" action="<?php echo base_url('index.php/Admin/insert_produk'); ?>" method="POST" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label class="col-md-12">Nama Produk</label>
                                    <div class="col-md-12">
                                        <input name = "nama_produk" type="text" placeholder="Nama Produk" class="form-control form-control-line"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Jenis Produk</label>
                                    <div class="col-md-12">
                                        <input name = "jenis" type="text" placeholder="Jenis Produk" class="form-control form-control-line"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Kode Produk</label>
                                    <div class="col-md-12">
                                        <input name = "kode" type="text" placeholder="Kode Produk" class="form-control form-control-line"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Ukuran</label>
                                    <div class="col-md-12">
                                        <input name="ukuran" type="text" value="Ukuran" class="form-control form-control-line"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Harga</label>
                                    <div class="col-md-12">
                                        <input name ="harga" type="text" placeholder="Harga" class="form-control form-control-line"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Deskripsi</label>
                                    <div class="col-md-12">
                                        <textarea name ="deskripsi" type="text" placeholder="Deskripsi" class="form-control form-control-line" rows="5"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td> <a href="<?php echo base_url('index.php/Welcome/delete_produk/'). $x['kode']; ?>"><button type="button" class="btn btn-danger"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a> </td>
                                            <td> <a href="<?php echo base_url('index.php/Admin/edit_produk/'). $x['kode']; ?>"><button type="button" class="btn btn-primary"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a> </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
