...
<head>
    ...
    <title>Muda Berkarya - Pesanan</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">List Pesanan</h4> </div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td> <a href="<?php echo base_url('index.php/Welcome/delete/'). $x['id_pesan']; ?>"><button type="button" class="btn btn-danger"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a></td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
